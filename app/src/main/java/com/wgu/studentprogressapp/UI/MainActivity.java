...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repo.insert(term3);
        Class class1 = new Class(1, "Class 1", "01/01/2022", "06/06/2022", "In-Progress", "Mr. Saturday", "333-444-5555", "mrsaturday@school.com", "", 1);
        repo.insert(class1);
        Class class2 = new Class(2, "Class 2", "01/01/2022", "06/06/2022", "In-Progress", "Mr. Saturday", "333-444-5555", "mrsaturday@school.com", "", 1);
        repo.insert(class2);
        Class class3 = new Class(3, "Class 3", "01/01/2022", "06/06/2022", "In-Progress", "Mr. Saturday", "333-444-5555", "mrsaturday@school.com", "", 1);
        repo.insert(class3);
